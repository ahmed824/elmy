                ...
                <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="w-full md:w-1/2 text-center md:text-right mt-10 md:mt-0">
                        ...
                        <h2 className="text-2xl md:text-3xl font-medium mt-3">
                            كيف يحقق المتعلمون مثلك أهدافهم
                        </h2>
                        <p className="text-gray-600 mt-2 max-w-md">
                            سواء كنت ترغب في التعلم أو مشاركة ما تعرفه، فقد وصلت إلى المكان
                            الصحيح. بإمكانك جودة عالية للتعلم.
                        </p>
                        <div className="flex justify-center md:justify-start gap-10 mt-6" data-aos="fade-up">
                            <div>
                                <p className="text-2xl font-bold">
                                    {studentsCount}
                                </p>
                                <span className="text-gray-500">متدرب</span>
                            </div>
                            <div>
                                <p className="text-2xl font-bold">
                                    {instructorsCount}
                                </p>
                                <span className="text-gray-500">مدرب معتمد</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 relative">
                        ...
                        <div id="custom-pagination" className="mt-6 flex justify-center space-x-2"></div>
                    </div>
                </div>
            </div>
