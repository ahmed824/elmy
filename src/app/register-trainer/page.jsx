...
export default function page() {
    return (
        <div className="min-h-screen">
            ...
            <div className='container mx-auto -mt-20 pb-40 px-4 md:px-10 lg:px-20 py-10 flex flex-col-reverse md:flex-row items-center'>
                <div className='w-full md:w-1/2 text-center md:text-right' data-aos="fade-left">
                    <span className="text-sm text-mainColor bg-purple-200 px-3 py-1 rounded-full">
                        اهلا بكم في علمي
                    </span>
                    <h2 className="text-2xl text-[#A436F0] md:text-3xl font-bold mt-3">
                        سجل كمدرب الآن و انشر محتواك
                    </h2>
                    <p className='font-medium text-[18px] md:text-[26px] text-[#121D2F] leading-relaxed mt-3'>
                    ...
                    <div className="mt-6 flex justify-center md:justify-start">
                        <Link href='/register-instructor' className="bg-gradient-to-r from-[#A436F0] via-[#637FEA] to-[#A436F0] text-white px-4 md:px-6 py-2 rounded-full flex items-center gap-2">
